// =====================================================================
// RhythmSleep — Main Arduino Sketch (.ino)
...
#include "src/eeg_processing.h"
#include "src/neural_network.h"
#include "src/sleep_tracker.h"
#include "src/rtc_manager.h"
#include "src/sd_manager.h"
#include "src/alarm_controller.h"
...
//
// Runs at 256 Hz (every ~3906 us), reading the ADC and applying the
...
static void eegSamplingTask(void* param) {
    const unsigned long sampleIntervalUs = 1000000UL / EEG_SAMPLE_RATE; // ~3906 us
